...
fun SignupScreen(
    isLoading: Boolean,
    errorMessage: String?,
    onSignupClick: (fullName: String, email: String, password: String, confirmPass: String) -> Unit,
    ...
    Scaffold(
        ...
        modifier = modifier.fillMaxSize().testTag("signup_screen")
    ) { innerPadding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Text(
                text = "Create your account to sync bookmarks and preferences",
            ...
            OutlinedTextField(
                ...
                leadingIcon = {
                    Icon(imageVector = Icons.Default.Person, contentDescription = "Name", tint = DeepNavy)
                },
                singleLine = true,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            OutlinedTextField(
                ...
                leadingIcon = {
                    Icon(imageVector = Icons.Default.Lock, contentDescription = "Confirm Password", tint = DeepNavy)
                },
                singleLine = true,
                visualTransformation = if (isPasswordVisible) VisualTransformation.None else PasswordVisualTransformation(),
                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password),
